...
// 加密密钥
const SECRET_KEY = '1A3F5E7D9B2C4A6E8D0F2B4C6A8E5D7F'
// 密码加密函数
...
const submit = async () => {
  ...
  try {
    if (loginStatus.value === '登录') {
      ...
      let role = roleList.value.find(item => item.key === loginModel.roleId)
      let registerData = {
      ...
      <div class="login-main">
        ...
        <div class="login-right">
          <div class="login-form-wrapper">
            ...
            <a-form ref="formRef" :model="loginModel" class="login-form" @keyup.enter="submit">
              ...
              <a-form-item name="phone" :rules="[{ required: true, message: '请输入联系方式' }]" v-if="loginStatus === '注册'">
                <a-input v-model:value="loginModel.phone" size="large" placeholder="请输入联系方式">
                  <template #prefix>
                    <SmileOutlined />
                  </template>
                </a-input>
